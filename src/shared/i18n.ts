...
export const zhTranslations: Record<string, string> = {
  ...
  'List view': '列表视图',
  'Loading...': '加载中...',
  'Codex session history': 'Codex 会话历史',
  'Codex session history button': 'Codex 会话历史按钮',
  'Show the history button in Codex tabs to view local Codex conversation records.':
    '在 Codex 标签栏显示历史按钮，用于查看本地 Codex 对话记录。',
  'Choose Codex session': '选择 Codex 会话',
  'Codex sessions in this directory': '当前目录的 Codex 会话',
  'Back to session list': '返回会话列表',
  'Back to current session': '回到当前会话',
  'Bind session': '绑定会话',
  ...
  'Last active': '最后活动',
  'Manual session id': '手动输入会话 ID',
  'Paste Codex session id': '粘贴 Codex 会话 ID',
  'Use session id': '使用会话 ID',
  'Waiting for Codex session id': '等待 Codex 会话 id',
  'Failed to load Codex history': '加载 Codex 历史失败',
  'Failed to load Codex sessions': '加载 Codex 会话失败',
  'No Codex history found': '未找到 Codex 历史',
  'No Codex sessions found for this directory': '当前目录下未找到 Codex 会话',
  'History is truncated. Load more to continue.': '历史内容较长，点击加载更多继续查看。',
